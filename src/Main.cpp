...
using namespace std;
// So that we can write `vector` rather than `std::vector`
...
SFError InitGraphics() {
	...
	// Create a new window
	g_window = SDL_CreateWindow("StarShip Fontana", SDL_WINDOWPOS_CENTERED,
...
int main(int arc, char ** argv) {
	...
	// Initialise world
	std::shared_ptr<SFWindow> window = make_shared < SFWindow
			> (g_window, g_renderer);
