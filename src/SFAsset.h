...
public:
	...
	virtual void GoEast();
	virtual void GoWest();
	virtual void GoNorth(); //missiles
	virtual void GoUp(); //player
	virtual void GoSouth();
	virtual void SetNotAlive();
	virtual bool IsAlive();
	virtual void HandleCollision();
	virtual void HandleCollisionObject();
...
private:
	...
	bool checkCollideNorth = false;
	bool checkCollideSouth = false;
	bool checkCollideWest = false;
	bool checkCollideEast = false;
